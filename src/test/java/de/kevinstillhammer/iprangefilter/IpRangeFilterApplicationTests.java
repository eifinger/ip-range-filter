...
@ContextConfiguration(initializers = {IpRangeFilterApplicationTests.MockServerInitializer.class}, classes = {IpRangeFilterApplication.class})
@Testcontainers
class IpRangeFilterApplicationTests{
	...
	@Container
	public static final MockServerContainer mockServer = new MockServerContainer(
			DockerImageName
					.parse(
	...
	public static class MockServerInitializer
		...
		public void initialize(@NotNull ConfigurableApplicationContext configurableApplicationContext) {
			...
			TestPropertySourceUtils.addInlinedPropertiesToEnvironment(
					configurableApplicationContext, "awsUrl=" + mockServer.getEndpoint() + "/ip-ranges.json");
		}
